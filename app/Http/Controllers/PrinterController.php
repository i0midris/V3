                ...
                ->addColumn(
                    ...
                    '
                        <div class="tw-flex tw-flex-wrap tw-gap-1">
                            @can("printer.update")
                                <a href="{{action(\'App\Http\Controllers\PrinterController@show\', [$id])}}" class="custom-tbtn tw-dw-btn-outline tw-dw-btn-secondary"><i class="glyphicon glyphicon-eye-open"></i> @lang("messages.view")</a>
                                <a href="{{action(\'App\Http\Controllers\PrinterController@edit\', [$id])}}" class="custom-tbtn tw-dw-btn-outline tw-dw-btn-primary"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</a>
                            @endcan
                            @can("printer.delete")
                                <button data-href="{{action(\'App\Http\Controllers\PrinterController@destroy\', [$id])}}" class="custom-tbtn tw-dw-btn-outline tw-dw-btn-error delete_printer_button"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>
                            @endcan
                        </div>
                    '
                )
