                ...
                ->addColumn(
                    ...
                    '
                        <div class="tw-flex tw-flex-wrap tw-gap-1">
                            @can("tax_rate.update")
                                <button data-href="{{action(\'App\Http\Controllers\TaxRateController@edit\', [$id])}}" class="custom-tbtn tw-dw-btn-outline tw-dw-btn-primary edit_tax_rate_button"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>
                            @endcan
                            @can("tax_rate.delete")
                                <button data-href="{{action(\'App\Http\Controllers\TaxRateController@destroy\', [$id])}}" class="custom-tbtn tw-dw-btn-outline tw-dw-btn-error delete_tax_rate_button"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>
                            @endcan
                        </div>
                    '
                )
