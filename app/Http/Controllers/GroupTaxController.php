                ...
                ->addColumn(
                    ...
                    '
                        <div class="tw-flex tw-flex-wrap tw-gap-1">
                            <button data-href="{{action(\'App\Http\Controllers\GroupTaxController@edit\', [$id])}}" class="custom-tbtn tw-dw-btn-outline tw-dw-btn-primary btn-modal" data-container=".tax_group_modal"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>
                            <button data-href="{{action(\'App\Http\Controllers\GroupTaxController@destroy\', [$id])}}" class="custom-tbtn tw-dw-btn-outline tw-dw-btn-error delete_tax_group_button"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>
                        </div>
                    '
                )
