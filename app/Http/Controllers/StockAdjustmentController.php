...
class StockAdjustmentController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            ->groupBy('transactions.id', 'transaction_date', 'ref_no', 'BL.name', 'adjustment_type', 'final_total', 'total_amount_recovered', 'additional_notes', 'u.id', 'u.surname', 'u.first_name', 'u.last_name')
            ->select(
                'transactions.id',
                'transaction_date',
                'ref_no',
                ...
                DB::raw('SUM(sal.quantity) as total_qty'),
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (! empty($products)) {
                ...
                (new \App\Utils\ModuleUtil)->getModuleData('MKamel_store666', ['request' => $request, 'products' => $products, 'stock_adjustment' => $stock_adjustment]);
