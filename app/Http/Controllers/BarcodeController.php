        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($barcodes)
                ->addColumn(
                    ...
                    <a href="{{action(\'App\Http\Controllers\BarcodeController@edit\', [$id])}}" class="custom-tbtn tw-dw-btn-outline tw-dw-btn-primary"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</a>
                        <button type="button" data-href="{{action(\'App\Http\Controllers\BarcodeController@destroy\', [$id])}}" class="custom-tbtn tw-dw-btn-outline tw-dw-btn-error delete_barcode_button" @if($is_default) disabled @endif><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>
                        @if($is_default)
                        ...
                        @else
                            <button class="custom-tbtn btn-info set_default" data-href="{{action(\'App\Http\Controllers\BarcodeController@setDefault\', [$id])}}">@lang("barcode.set_as_default")</button>
                        @endif
                    </div>    
                    '
                )
