    ...
    */
    ...
    public function postBusinessSettings(Request $request)
    {
        ...
        try {
            ...
            $business->currency_settings_enabled = $request->has('currency_settings_enabled') ? 1 : 0;
