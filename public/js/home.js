$(document).ready(function() {
    ...
    var stock_alert_table = $('#stock_alert_table').DataTable({
        ...
        scrollCollapse: true,
        fixedHeader: false,
        // dom: '<"dt-section-buttons tw-mb-4 tw-grid tw-grid-cols-2 md:grid-cols-4"B>r<"dt-section-table tw-rounded-md tw-mb-4"t><"dt-section-footer tw-px-4 tw-flex tw-justify-between tw-items-center"ip>',
        dom: '<"dt-section-toolbar psa"<"dt-buttons"B>>r<"dt-section-table tw-rounded-md tw-mb-4"t><"dt-section-footer tw-px-2 tw-flex tw-justify-between tw-items-center"ip>',
        initComplete: function () {
            // first inject the class into toolbar div then make it show
            const $filter = $('#product_stock_alert_lf');
            const $container = $('.psa');
    ...
    purchase_payment_dues_table = $('#purchase_payment_dues_table').DataTable({
        ...
        fixedHeader: false,
        // dom: '<"dt-section-buttons tw-mb-4 tw-grid tw-grid-cols-2 md:grid-cols-4"B>r<"dt-section-table tw-rounded-md tw-mb-4"t><"dt-section-footer tw-px-4 tw-flex tw-justify-between tw-items-center"ip>',
        dom: '<"dt-section-toolbar ppd"<"dt-buttons"B>>r<"dt-section-table tw-rounded-md tw-mb-4"t><"dt-section-footer tw-px-2 tw-flex tw-justify-between tw-items-center"ip>',
        initComplete: function () {
            // first inject the class into toolbar div then make it show
            const $filter = $('#purchase_payment_dues_lf');
            const $container = $('.ppd');
    ...
    sales_payment_dues_table = $('#sales_payment_dues_table').DataTable({
        ...
        scrollCollapse: true,
        fixedHeader: false,
        // dom: '<"dt-section-buttons spd tw-mb-4 tw-grid tw-grid-cols-2 md:grid-cols-4"B>r<"dt-section-table tw-rounded-md tw-mb-4"t><"dt-section-footer tw-px-2 tw-flex tw-justify-between tw-items-center"ip>',
        dom: '<"dt-section-toolbar spd"<"dt-buttons"B>>r<"dt-section-table tw-rounded-md tw-mb-4"t><"dt-section-footer tw-px-2 tw-flex tw-justify-between tw-items-center"ip>',
        initComplete: function () {
            // first inject the class into toolbar div then make it show
            const $filter = $('#sales_payment_dues_lf');
            const $container = $('.spd');
...
function update_statistics(start, end) {
    ...
    var loader = '<i class="fas fa-sync fa-spin fa-fw tw-mt-2"></i>';
