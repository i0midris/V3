...
@section('title', __('accounting::lang.add_expense'))
...
<section class="content-header">
    <h1>@lang('accounting::lang.add_expense')</h1>
</section>

<!-- Main content -->
<section class="content">
    {!! Form::open(['url' => action([\Modules\Accounting\Http\Controllers\TransferController::class, 'expense_store']),
