...
<section class="content no-print">
    ...
    @component('components.filters', ['title' => __('report.filters')])
        <div class="row tw-border-b tw-pb-4">
            <div class="col-sm-4">
                <div class="form-group">
                    {!! Form::label('location_id', __('business.business_locations') ) !!}
            ...
            <div class="col-sm-2" style="padding-top: 1.5rem">
                <div class="form-group">
                <a style="width: 100px;" class="add-btn" href="javascript:void(0)" onclick="goto()">
                    @lang('report.filters')
                </a>
                </div>
            </div>
        ...
        <div class="row tw-mt-4 tw-pt-4">
            ...
            <div class="col-sm-2">
                <div class="form-group">
                <a style="width: 100px;" class="add-btn" href="javascript:void(0)" onclick="search_now()">
                    @lang('lang_v1.search')
                </a>
                </div>
            </div>
    ...
    @component('components.widget', ['class' => 'box-solid'])
        ...
        @can('accounting.add_journal')
            <div style="margin-bottom:4rem">
                <div class="row" style="margin-bottom: 5px !important;">
                    <div class="col-md-4">
                        <a class="add-btn tw-gap-2 tw-w-full"
                           href="{{action([\Modules\Accounting\Http\Controllers\JournalEntryController::class, 'create'])}}">
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="14"  height="14"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="3"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-plus"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 5l0 14" /><path d="M5 12l14 0" /></svg> @lang( 'accounting::lang.add_journal' )</a>
                    </div>
                    <div class="col-md-4">
                        <button type="button" class="add-btn tw-gap-2 tw-w-full btn-modal"
        ...
        @forelse($data as $journal)
            <div class="table-responsive tw-mt-4 manage-currency-table reports-table">
                <table class="table cf tw-border table-hover">
                    <thead class="cf" >
                        <tr class="tw-text-white tw-bg-@if(!empty(session('business.theme_color'))){{session('business.theme_color')}}@else{{'primary'}}@endif-800">
                            ...
                            <th style="text-align: end;">
                                <a href="#" class="btn-modal" data-href="{{ action([\Modules\Accounting\Http\Controllers\JournalEntryController::class, 'print'], [$journal->id]) }}"  data-container=".view_modal">
                                    <i style="color: white !important" class="fa fa-print " data-toggle="tooltip" data-placement="bottom" title="" data-original-title="@lang('messages.print')"></i>
                                </a>
                                <?php
                                ...
                                <a href="{{action([\Modules\Accounting\Http\Controllers\JournalEntryController::class, 'edit'], [$journal->id])}}">
                                    <i style="color: white !important" class="fas fa-edit " data-toggle="tooltip" data-placement="bottom" title="" data-original-title="@lang('messages.edit')"></i>
                                </a>
                                <?php
                                    }
                                }
                                ...
                                <a class="print-invoice" href="#" data-href="{{action([\Modules\Accounting\Http\Controllers\JournalEntryController::class, 'print_expense'], [$journal->id])}}">
                                    <i style="color: white !important" class="fa fa-print" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="@lang('expense.add_expense')"></i>
                                </a>
                                ...
                                <a class="print-invoice" href="#" data-href="{{action([\Modules\Accounting\Http\Controllers\JournalEntryController::class, 'print_receipt'], [$journal->id])}}">
                                    <i style="color: white !important" class="fa fa-print" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="@lang('accounting::lang.add_receipt')"></i>
                                </a>
                                ...
                                <a href="#" 
                                    ...
                                    class="btn-modal" 
                                    data-container="#create_opening_balance_modal">
                                    <i class="fas fa-edit" style="color: white !important" data-toggle="tooltip" title="@lang('messages.edit')"></i>
                                </a>
                    ...
                    <tbody>
                        ...
                        <tr style="background-color: #e9ecef;">
                            <td colspan="6" ><span class="tw-font-bold">@lang('purchase.payment_note')</span> {{$journal->note}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
