<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
        <div class="row">
            <div class="form-group col-sm-6" style="pointer-events: none;">
            ...
            <div class="form-group col-sm-6">
                ...
                {!! Form::text('gl_code', $account->gl_code, ['class' => 'form-control', 'placeholder' => __( 'accounting::lang.gl_code' ),'readonly' => 'readonly' ]); !!}
