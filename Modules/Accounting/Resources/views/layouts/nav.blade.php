            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    @if(auth()->user()->can('accounting.manage_accounts'))
                        ...
                        <li @if(request()->segment(2) == 'ledger') class="active" @endif><a href="{{action([\Modules\Accounting\Http\Controllers\CoaController::class, 'ledger'], \Modules\Accounting\Utils\AccountingUtil::getAccountingAccountID(4101))}}">@lang('accounting::lang.ledger')</a></li>
                    @endif
