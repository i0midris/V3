...
|
*/
Route::get('getOpeningBalance', [\Modules\Accounting\Http\Controllers\CoaController::class, 'getOpeningBalance'])->name('getOpeningBalance');
Route::get('getClosingBalance', [\Modules\Accounting\Http\Controllers\CoaController::class, 'getClosingBalance'])->name('getClosingBalance');
Route::get('getSalesDiscount', [\Modules\Accounting\Http\Controllers\CoaController::class, 'getSalesDiscount'])->name('getSalesDiscount');
Route::get('getDiscountOnPurchases', [\Modules\Accounting\Http\Controllers\CoaController::class, 'getDiscountOnPurchases'])->name('getDiscountOnPurchases');
Route::get('getAllBlanace', [\Modules\Accounting\Http\Controllers\CoaController::class, 'getAllBlanace'])->name('getAllBlanace');
Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->prefix('accounting')->group(function (): void {
    ...
    Route::get('locations-dropdown', [\Modules\Accounting\Http\Controllers\AccountingController::class, 'LocationsDropdown'])->name('locations-dropdown');
    ...
    Route::get('edit_link/{id}/{link_table}/edit', [\Modules\Accounting\Http\Controllers\CoaController::class, 'edit_link']);
    Route::put('edit_link/{id}/update', [\Modules\Accounting\Http\Controllers\CoaController::class, 'update_link']);

    Route::resource('journal-entry', \Modules\Accounting\Http\Controllers\JournalEntryController::class);
    Route::get('new-journal-entry', [\Modules\Accounting\Http\Controllers\JournalEntryController::class, 'getData']);
    Route::get('print-journal-entry/{id}', [\Modules\Accounting\Http\Controllers\JournalEntryController::class, 'print']);
    Route::get('print-receipt/{id}', [\Modules\Accounting\Http\Controllers\JournalEntryController::class, 'print_receipt']);
    Route::get('print-expense/{id}', [\Modules\Accounting\Http\Controllers\JournalEntryController::class, 'print_expense']);
    ...
    Route::get('opening_balance1/create', [\Modules\Accounting\Http\Controllers\TransferController::class, 'opening_balance_create1']);
    Route::get('opening_balance2/create', [\Modules\Accounting\Http\Controllers\TransferController::class, 'opening_balance_create2']);
    Route::post('opening_balance/store', [\Modules\Accounting\Http\Controllers\TransferController::class, 'opening_balance_store']);
    Route::get('opening_balance/{id}/edit', [\Modules\Accounting\Http\Controllers\TransferController::class, 'opening_balance_edit']);
    Route::put('opening_balance/{id}/update', [\Modules\Accounting\Http\Controllers\TransferController::class, 'opening_balance_update']);
    Route::get('expense/create', [\Modules\Accounting\Http\Controllers\TransferController::class, 'expense_create']);
    Route::post('expense/store', [\Modules\Accounting\Http\Controllers\TransferController::class, 'expense_store']);
    Route::get('expense/{id}/edit', [\Modules\Accounting\Http\Controllers\TransferController::class, 'expense_edit']);
    Route::put('expense/{id}/update', [\Modules\Accounting\Http\Controllers\TransferController::class, 'expense_update']);

    Route::get('receipt/create', [\Modules\Accounting\Http\Controllers\TransferController::class, 'receipt_create']);
    Route::post('receipt/store', [\Modules\Accounting\Http\Controllers\TransferController::class, 'receipt_store']);
    Route::get('receipt/{id}/edit', [\Modules\Accounting\Http\Controllers\TransferController::class, 'receipt_edit']);
    Route::put('receipt/{id}/update', [\Modules\Accounting\Http\Controllers\TransferController::class, 'receipt_update']);
    ...
    Route::get('reports/contact-linked-accounts',
    [\Modules\Accounting\Http\Controllers\ReportController::class, 'contactLinkedAccountsReport'])
    ->name('accounting.contact_linked_accounts_report');    
