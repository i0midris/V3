...
Route::group(['middleware' => ['web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu'], 'prefix' => 'inventorymanagement', 'namespace' => 'Modules\InventoryManagement\Http\Controllers'], function (): void {
