    ...
    <section class="content tw-mt-4">
        <div class="box box-solid">
            <div class="box-header">
                <h3 class="box-title">@lang("inventorymanagement::inventory.products_reports_increase")</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="table-responsive">
                            <table id="example1" class="table tw-border table-striped nowrap" style="width:100%;border-bottom-color:#ddd;">
