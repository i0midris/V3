<!-- Modules\Manufacturing\Resources\views\layouts\partials\common_script.blade.php -->
...
$(document).on('click', '#update_recipe_totals', function (e) {
    e.preventDefault();
    ...
    Swal.fire({
        ...
        $.ajax({
            method: 'POST',
            url: '/manufacturing/update-recipe-totals',
            dataType: 'json',
            data: {
                recipe_ids: selected_rows,
...
$(document).on('click', 'button.delete_recipe', function (e) {
    e.preventDefault();
    ...
    Swal.fire({
        title: LANG.sure,
        text: LANG.confirm_delete, // optional: add to lang file
        icon: 'warning',
        showCancelButton: true,
        confirmButtonText: LANG.ok,
        cancelButtonText: LANG.cancel,
