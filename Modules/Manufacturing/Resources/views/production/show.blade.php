                ...
                <div class="col-md-12">
                    <table class="table table-striped tw-border">
                        ...
                        <tfoot style="background-color: #e9ecef;">
                            ...
                            <tr>
                                <td colspan="4" class="text-right"><strong>{{__('manufacturing::lang.total_quantity')}}:</strong></td>
                                <td><span class="display_currency" data-currency_symbol="false">{{ @format_quantity($total_final_quantity) }} {{ $unit_name }}</span> </td>
                            </tr>
                            <tr>
