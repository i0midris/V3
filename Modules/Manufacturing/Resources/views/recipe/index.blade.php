        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped" id="recipe_table">
                ...
                <tfoot>
                    <tr>
                        <td colspan="8">
                            <button type="button" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error" id="mass_update_product_price">
                                @lang('manufacturing::lang.update_product_price')
                            </button>
                            @show_tooltip(__('manufacturing::lang.update_product_price_help'))
                            <button type="button" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-accent ml-2" id="update_recipe_totals">
                                @lang('manufacturing::lang.update_recipe_total')
                            </button>
                            @show_tooltip(__('manufacturing::lang.update_recipe_total_help'))
                        </td>
                    </tr>
                </tfoot>
            </table>
