...
class SuperadminServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view::composer('superadmin::layouts.partials.active_subscription', function ($view): void {
        ...
        view::composer(['layouts.partials.home_header'], function ($view): void {
        ...
        view::composer(['superadmin::layouts.partials.currency'], function ($view): void {
