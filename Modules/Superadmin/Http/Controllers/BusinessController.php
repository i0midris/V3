...
class BusinessController extends BaseController
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $businesses = Business::leftjoin('subscriptions AS s', function ($join) use ($date_today): void {
            ...
            if ($subscription_status == 30) {
                ...
                $businesses->where(function ($q): void {
            ...
            return Datatables::of($query)
                ...
                ->filterColumn('owner_name', function ($query, $keyword): void {
                ...
                ->filterColumn('business_contact_number', function ($query, $keyword): void {
