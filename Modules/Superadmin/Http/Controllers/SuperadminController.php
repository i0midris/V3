...
class SuperadminController extends Controller
{
    ...
    public function index()
    {
        ...
        $currency = System::getCurrency();
$currency_code = $currency?->currency ?? 'USD'; // Safe fallback if null

$monthly_sells_chart = new CommonChart;
$monthly_sells_chart->labels(array_keys($subscriptions))
    ->dataset(__('superadmin::lang.total_subscriptions', ['currency' => $currency_code]), 'column', array_values($subscriptions));
