...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.supplier_notifications') . ':'])
                ...
                <div class="callout callout-warning" style="margin-top:1rem;border-radius:.375rem">
    ...
    <div class="row tw-mt-5">
        <div class="col-md-12 text-center">
            <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-w-24">@lang('messages.save')</button>
        </div>
    </div>
