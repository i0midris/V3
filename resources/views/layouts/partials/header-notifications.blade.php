...
<li class="dropdown notifications-menu tw-list-none">
    ...
    <ul class="dropdown-menu hide-scrollbar !tw-p-2 !tw-w-80 tw-absolute !tw-z-10 !tw-mt-2 !tw-origin-top-right !tw-bg-white !tw-rounded-lg !tw-shadow-lg !tw-ring-1 !tw-ring-gray-200 !focus:tw-outline-none" style="left:-1rem ; height:80vh; overflow-y: auto;top:2.5rem;">
