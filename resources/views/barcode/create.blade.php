      ...
      <div class="form-group">
        <div class="checkbox">
          <label>
            ...
            <span class="tw-mx-4"> @lang('barcode.is_continuous')</span>
          </label>
          </div>
      </div>
    </div>
      ...
      <div class="form-group">
        <div class="checkbox">
          <label>
            ...
            <span class="tw-mx-4">@lang('barcode.set_as_default')</span>
          </label>
          </div>
      </div>
    </div>
    <div class="col-sm-12 text-center">
      <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-w-24 tw-text-white">@lang('messages.save')</button>
    </div>
  </div>
  @endcomponent
  {!! Form::close() !!}
