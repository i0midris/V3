  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        <div class="checkbox">
          <label>
             {!! Form::checkbox('for_tax_group', 1, !empty($tax_rate->for_tax_group), [ 'class' => 'input_icheck']); !!} 
             <span class="tw-mx-4">@lang( 'lang_v1.for_tax_group_only' )@show_tooltip(__('lang_v1.for_tax_group_only_help'))</span>
          </label> 
        </div>
      </div>
