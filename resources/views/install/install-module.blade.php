        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="box box-primary active">
              ...
              <form class="form" id="details_form" method="post" 
                    ...
                    <h2> License Details - <code>{{$module_display_name ?? 'Unknown Module'}} Module</code><br/><small class="text-danger"> Make sure to provide correct licensing information</small></h2>
                    <hr/>
