  ...
  @endphp
    ...
    <div class="modal-body">
        ...
        <div class="row">
                ...
                <div class="col-md-4 pay_term">
                  <div class="form-group">
                    <div class="multi-input">
                      ...
                      <br/>
                      <div class="input-group">
                          {!! Form::number('pay_term_number', null, ['class' => 'form-control input-group-addon width-40 pull-left', 'placeholder' => __('contact.pay_term')]); !!}
          ...
          <div class="col-md-8 col-md-offset-2 form-group shipping_addr_div mb-10" >
              <strong>{{__('lang_v1.shipping_address')}}</strong><br>
              {!! Form::text('shipping_address', null, ['class' => 'form-control tw-mt-2', 
    ...
    <div class="modal-footer">
      <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white" id="submit-btn">@lang( 'messages.save' )</button>
