  ...
  @endphp
    ...
    <div class="modal-body">
        ...
        <div class="col-md-4 pay_term">
          <div class="form-group">
            <div class="multi-input">
              ...
              <br/>
              <div class="input-group">
                {!! Form::number('pay_term_number', $contact->pay_term_number, ['class' => 'form-control input-group-addon width-40 pull-left', 'placeholder' => __('contact.pay_term')]); !!}
      ...
      <div class="col-md-8 col-md-offset-2 form-group shipping_addr_div mb-10" >
          ...
          {!! Form::text('shipping_address', $contact->shipping_address, ['class' => 'form-control tw-mt-2', 
