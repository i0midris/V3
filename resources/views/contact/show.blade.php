...
<section class="content no-print">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-solid" style="border-radius:0.5rem !important">
                <div class="box-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="nav-tabs-custom" style="border-radius:0.5rem !important;overflow:hidden">
                ...
                <div class="tab-content">
                    ...
                    @if(in_array($contact->type, ['both', 'supplier']))
                        ...
                        id="purchases_tab">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group tw-text-xl ">
                    ...
                    <div class="tab-pane 
                        ...
                        <div id="contact_payments_div" style="height: auto;overflow-y: scroll;"></div>
                    </div>
                    @if( in_array($contact->type, ['customer', 'both']) && session('business.enable_rp'))
                        <div class="tab-pane
                            @if(!empty($view_type) &&  $view_type == 'reward_point')
