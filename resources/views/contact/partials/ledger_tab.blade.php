<!-- resources\views\contact\partials\ledger_tab.blade.php -->
@php
    $transaction_types = [];
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-2 text-right tw-mt-4">
            <button data-href="{{action([\App\Http\Controllers\ContactController::class, 'getLedger'])}}?contact_id={{$contact->id}}&action=pdf" class="btn btn-default btn-md" id="print_ledger_pdf"><i class="fas fa-file-pdf"></i></button>

            <button type="button" class="btn btn-default btn-md" id="send_ledger"><i class="fas fa-envelope"></i></button>
        </div>
    </div>
