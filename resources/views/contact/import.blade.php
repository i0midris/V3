                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                {!! Form::file('contacts_csv', ['accept' => '.xls', 'class' => 'tw-p-1', 'required' => 'required']) !!}
                              </div>
                        </div>
                        <div class="col-sm-4">
                        <br>
                            <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-mt-0.5 tw-text-white">@lang('messages.submit')</button>
                        </div>
                        </div>
                    </div>
