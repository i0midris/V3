    		...
    		<div class="row">
    			<div class="col-md-6">
      				<div class="table-responsive">
      					<table class="table table-condensed tw-border table-striped">
     			...
     			<div class="col-md-6">
				    <div class="table-responsive">
					<table class="table tw-border table-striped @cannot('view_purchase_price') show_price_with_permission no-print @endcan">
						<tr>
				            <th>@lang('stock_adjustment.total_qty'):</th>
				            <td><span class="pull-right">
				                {{ @format_quantity($stock_adjustment->stock_adjustment_lines->sum('quantity')) }}
				            </span></td>
				        </tr>
				        <tr>
