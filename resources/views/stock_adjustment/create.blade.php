...
@section('content')
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::text('transaction_date', \Carbon\Carbon::now()->format('Y-m-d H:i'), [
                'class' => 'form-control',
                'required',
                'readonly',
            ]) !!}
                        ...
                        <table class="table tw-border table-striped table-condensed" id="stock_adjustment_product_table">
                            ...
                            <tfoot style="background-color: #e9ecef;">
                                <tr class="text-center show_price_with_permission">
                                    <td></td>
                                    <td>
                                        <div class="pull-center"><b>@lang('stock_adjustment.total_qty'):</b> <span
                                                id="total_qty_footer">0.00</span></div>
                                    </td>
                                    
                                    <td>
                                        <div class="pull-center"><b>@lang('stock_adjustment.total_amount'):</b> <span
