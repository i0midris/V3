      ...
      <table class="table show_price_with_permission">
        ...
        <tr>
          ...
          <td class="text-center">
            <b>@lang('sale.qty')</b>: {{ @format_quantity($total_qty) }}
          </td>
          <td class="text-center">
        ...
        <tr>
          <td colspan="4" class="text-right">
            <b>@lang('purchase.additional_shipping_charges') (+):</b>
            <span class="display_currency" data-currency_symbol="true">{{ $sell_transfer->shipping_charges }}</span>
          </td>
        </tr>
        @endif
        ...
        <tr>
          <td colspan="4" class="text-right">
            ...
            <span class="display_currency" data-currency_symbol="true">{{ $sell_transfer->final_total }}</span>
          </td>
        </tr>
