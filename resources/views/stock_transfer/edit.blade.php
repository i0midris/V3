			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						{!! Form::select('location_id', $business_locations, $sell_transfer->location_id, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'id' => 'location_id']); !!}
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
						{!! Form::label('transfer_location_id', __('lang_v1.location_to').':*') !!}
						{!! Form::select('transfer_location_id', $business_locations, $purchase_transfer->location_id, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'id' => 'transfer_location_id']); !!}
					</div>
				</div>
		...
		<div class="">
			...
			<div class="row">
				<div class="col-lg-10 col-lg-offset-1">
					...
					<table class="table tw-border table-striped table-condensed" id="stock_adjustment_product_table">
						<thead class="tw-text-white tw-bg-@if(!empty(session('business.theme_color'))){{session('business.theme_color')}}@else{{'primary'}}@endif-800">
							<tr>
								...
								<th colspan="2" class="col-sm-2 text-center show_price_with_permission">
									@lang('sale.subtotal')
								</th>
						...
						<tfoot style="background-color: #e9ecef;">
                                <tr class="text-center show_price_with_permission">
                                    <td colspan="1"></td>
                                    <td>
                                        <div class=""><b>@lang('sale.qty'): </b> <span
                                                id="qty_adjustment">0.00</span></div>
                                    </td>
                                    <td colspan="1"></td>
                                    <td>
                                        <div class=""><b>@lang('sale.total'): </b> <span
	...
	@component('components.widget', ['class' => 'box-solid'])
			...
			<div class="row">
				...
				<div class="col-sm-12 text-center">
					<button type="submit" id="save_stock_transfer" class="btn btn-primary">@lang('messages.save')</button>
				</div>
			</div>
		@endcomponent
<!--box end-->
