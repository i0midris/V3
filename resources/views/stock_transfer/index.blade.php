...
<section class="content-header no-print">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('lang_v1.stock_transfers')sdfbjm
    </h1>
</section>
...
<section class="content no-print">
    @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.all_stock_transfers')])
        @slot('tool')
            <div class="box-tools">
                @if(auth()->user()->can('purchase.create'))
                    <a 
                        class="add-btn tw-gap-1 pull-right"
        ...
        <div class="table-responsive">
            <table class="table tw-border table-striped ajax_view" id="stock_transfer_table">
