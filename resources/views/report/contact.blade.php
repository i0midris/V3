    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('min_days_ago', __('report.min_days_ago') . ':') !!}
                        {!! Form::number('min_days_ago', null, ['class' => 'form-control', 'id' => 'min_days_ago', 'placeholder' => 'مثال. 1']) !!}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('max_days_ago', __('report.max_days_ago') . ':') !!}
                        {!! Form::number('max_days_ago', null, ['class' => 'form-control', 'id' => 'max_days_ago', 'placeholder' => 'مثال. 30']) !!}
                    </div>
                </div>
                ...
                <table class="table table-bordered table-striped" id="supplier_report_tbl">
                    <thead class="tw-text-white tw-bg-@if(!empty(session('business.theme_color'))){{session('business.theme_color')}}@else{{'primary'}}@endif-800">
                        <tr>
                            ...
                            <th>@lang('report.last_transaction')</th>
                        </tr>
                    </thead>
