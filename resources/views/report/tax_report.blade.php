...
<section class="content">
    <div class="row no-print tw-px-4">
           ...
           <!-- Custom Tabs -->
            <div class="tw-rounded-lg tw-overflow-hidden tw-bg-white">
                ...
                <div class="tab-content tw-p-4">
                    <div class="tab-pane active tw-rounded-xl" id="input_tax_tab">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        input_tax_table = $('#input_tax_table').DataTable({
            ...
            fixedHeader:false,
            dom: `
                <"tw-mt-4 dt-section-toolbar tw-mb-4 tw-flex tw-flex-wrap tw-justify-between tw-items-center tw-gap-2 no-print"
                ...
                >
                rt
                <"tw-mt-4 tw-flex tw-justify-between tw-items-center no-print"ip>
            `,
            ajax: {
