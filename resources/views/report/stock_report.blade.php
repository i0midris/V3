    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table no-border">
                <tr>
                    <th>@lang('report.closing_stock') (@lang('lang_v1.by_purchase_price'))</th>
                    <th>@lang('report.closing_stock') (@lang('lang_v1.by_sale_price'))</th>
                    <th>@lang('lang_v1.potential_profit')</th>
                    <th>@lang('lang_v1.profit_margin')</th>
                </tr>
                <tr>
                    <td><p id="closing_stock_by_pp" class="mb-0 mt-0"></p></td>
                    <td><p id="closing_stock_by_sp" class="mb-0 mt-0"></p></td>
                    <td><p id="potential_profit" class="mb-0 mt-0"></p></td>
                    <td><p id="profit_margin" class="mb-0 mt-0"></p></td>
                </tr>
            </table>
            @endcomponent
        </div>
