...
<section class="content">
        ...
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => action([\App\Http\Controllers\ReportController::class, 'getExpenseReport']), 'method' => 'get' ]) !!}
                ...
                <div class="col-sm-12">
                  <button type="submit" class="add-btn !tw-text-xs pull-right">@lang('report.apply_filters')</button>
                </div> 
                {!! Form::close() !!}
            @endcomponent
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
        @component('components.widget', ['class' => 'box-primary'])
            <table class="table table-striped tw-border" id="expense_report_table">
                ...
                <tfoot style="background-color: #e9ecef;">
                    <tr>
                        <td class="tw-font-bold">@lang('sale.total')</td>
