              ...
              {!! Form::open(['url' => action([\App\Http\Controllers\ReportController::class, 'getStockReport']), 'method' => 'get', 'id' => 'sales_representative_filter_form' ]) !!}
                ...
                <div class="col-md-2">
                    <div class="form-group" style="margin-top:10%">
                        <button type="button" id="print_report_btn" class="btn btn-primary">
...
@section('javascript')
    ...
    let query = $('#sales_representative_filter_form').serialize();
    let url = "{{ route('reports.sales_representative.print') }}?" + query;
