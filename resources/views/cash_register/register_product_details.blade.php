<div class="row">
  <div class="col-md-12">
    <hr>
    <h4>@lang('lang_v1.product_sold_details_register')</h4>
    <table class="table tw-border table-striped table-condensed">
...
<div class="row">
  <div class="col-md-12">
    <hr>
    <h4>@lang('lang_v1.product_sold_details_register') (@lang('lang_v1.by_brand'))</h4>
