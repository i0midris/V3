...
{!! Form::open(['url' => action([\App\Http\Controllers\BusinessController::class, 'postBusinessSettings']), 'method' => 'post', 'id' => 'bussiness_edit_form',
    ...
    <div class="row">
       ...
       <!--  <pos-tab-container> -->
        ...
        @component('components.widget', ['class' =>  'pos-tab-container'])
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 pos-tab-menu tw-rounded-lg">
                <div class="list-group">
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base  active">@lang('business.business')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('business.tax') @show_tooltip(__('tooltip.business_tax'))</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('business.product')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('contact.contact')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('business.sale')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('sale.pos_sale')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('purchase.purchases')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('lang_v1.payment')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('business.dashboard')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('business.system')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('business.currency_settings')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('lang_v1.prefixes')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('lang_v1.email_settings')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('lang_v1.sms_settings')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('lang_v1.reward_point_settings')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('lang_v1.modules')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('lang_v1.custom_labels')</a>
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-xs md:tw-text-base">@lang('business.system_update')</a>

                </div>
            </div>
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-9 pos-tab">
                <!-- tab 1 start -->
                ...
                <!-- tab 7 end -->
                 <!-- tab 14 start ' system update -->
                @include('business.partials.settings_currency')
                <!-- tab 14 end -->
                <!-- tab 8 start -->
                ...
                <!-- tab 13 start ' system update -->
                @include('business.partials.settings_system_update')
                <!-- tab 13 end -->
    ...
    <div class="row">
        <div class="col-sm-12 text-center">
            <button class="add-btn tw-text-white" type="submit">@lang('business.update_settings')</button>
        </div>
    </div>
{!! Form::close() !!}
</section>
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        $('#updateResult')
                            ...
                            .html("✅ " + (res.message ?? '{{ __("business.update_successful") }}'));

                        toastr.success(res.message ?? '{{ __("business.update_successful") }}');
                    },
                    error: function (xhr) {
                        Swal.close();
        ...
        Swal.fire({
            ...
            didOpen: () => {
                fetch("{{ route('system.whats_new') }}")
                    .then(res => res.text())
                    .then(html => {
                        $('#whatsNewContent').html(html);
                    }).catch(() => {
                        $('#whatsNewContent').html('<p>Unable to load changelog.</p>');
                    });
            }
        });
    });
