<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-xs-12 tw-mt-4 test_email_btn @if(!empty($email_settings['use_superadmin_settings'])) hide @endif">
            <button type="button" class="add-btn pull-right tw-mt-5" id="test_email_btn">@lang('lang_v1.test_email_configuration')</button>
        </div>
    </div>
</div>