    ...
    <section class="content">
                ...
                @component('components.filters', ['title' => __('report.filters')])
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <br>
                            <label>
                                {!! Form::checkbox('not_for_selling', 1, ['class' => 'input-icheck', 'id' => 'not_for_selling']) !!} <strong>@lang('lang_v1.not_for_selling')</strong>
                            </label>
                        </div>
                    </div>
                    @if ($is_woocommerce)
        ...
        @can('product.view')
            <div class="row">
                <div class="col-md-12">
                    <!-- Custom Tabs -->
                    <div class="nav-tabs-custom" style="border-radius: 0.5rem;overflow:hidden">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active " id="product_list_tab">
                                <div class="row" style="margin:1rem 0.5rem 2rem 0.5rem !important">
                                    @if ($is_admin)
                                        <a class="pull-right add-btn tw-gap-1"
            ...
            if ($(e.target).attr('href') == '#product_stock_report') {
                if (!data_table_initailized) {
                    ...
                    stock_report_table = $('#stock_report_table').DataTable({
                        ...
                        fixedHeader:false,
                        dom: `
                            <"tw-mb-4 tw-mt-4 tw-flex tw-flex-wrap tw-justify-between tw-items-center tw-gap-4"
                                <"tw-flex tw-items-center tw-gap-2"B l>
                                f
                            >
                            rt
