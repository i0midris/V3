              ...
              <div class="form-group">
                {!! Form::label('rack_' . $id,  $location . ':') !!}
                  ...
                  @if(!empty($rack_details[$id]))
                    ...
                    @endif
                  @else
                    {!! Form::text('product_racks[' . $id . '][rack]', null, ['class' => 'form-control tw-mt-1', 'id' => 'rack_' . $id, 'placeholder' => __('lang_v1.rack')]); !!}

                    {!! Form::text('product_racks[' . $id . '][row]', null, ['class' => 'form-control tw-mt-1', 'placeholder' => __('lang_v1.row')]); !!}

                    {!! Form::text('product_racks[' . $id . '][position]', null, ['class' => 'form-control tw-mt-1', 'placeholder' => __('lang_v1.position')]); !!}
                  @endif
        ...
        <div class="col-sm-12">
          <div class="text-center">
            <div class="btn-group">
              ...
              <button type="submit" @if(empty($product->enable_stock)) disabled="true" @endif id="opening_stock_button"  value="update_n_edit_opening_stock" class="tw-dw-btn tw-text-white bg-purple submit_product_form">@lang('lang_v1.update_n_edit_opening_stock')</button>
              @endif

              <button type="submit" value="save_n_add_another" class="tw-dw-btn tw-text-white bg-maroon submit_product_form">@lang('lang_v1.update_n_add_another')</button>

              <button type="submit" value="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white submit_product_form tw-mt-1 sm:tw-mt-0">@lang('messages.update')</button>
            </div>
          </div>
        </div>
  </div>
