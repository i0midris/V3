                ...
                <div class="tab-content tw-p-4">
                    <div class="tab-pane active" id="tab_1">
                        <div class="row">
                            <div class="col-md-12">
                                <h4>@lang( 'receipt.receipt_settings')
                                    <small class="!tw-text-xs">@lang( 'receipt.receipt_settings_mgs')</small>
                                </h4>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-center tw-mt-5 tw-mb-4">
                                    <button class="add-btn" type="submit">@lang('messages.update')</button>
                                </div>
                            </div>
                            {!! Form::close() !!}
                            </div>
