<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="row">
          @if(!empty($currency_rates) && count($currency_rates) > 0)
            <div class="form-group col-md-6">
              ...
              <div class="input-group">
                ...
                {!! Form::select('currency_code', 
                    $currency_rates->pluck('currency_name', 'currency_code'), 
                    null, 
                    ['class' => 'form-control select2', 'id' => 'currency_code', 'style' => 'width:100%;', 'placeholder' => __('lang_v1.select_currency')]
                ) !!}
              </div>
            </div>
          @endif
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" id="exchange_rate_display" readonly value="1">
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
...
<div class="col-md-6" id="base_amount_wrapper" style="display: none;">
  <div class="form-group">
    ...
    <div class="input-group">
      ...
      {!! Form::text('base_amount_input', null, [
          'class' => 'form-control input_number',
          'id' => 'base_amount_input',
          'placeholder' => __('lang_v1.base_amount'),
        ])
      !!}
    </div>
  </div>
</div>
{!! Form::hidden('exchange_rate', 1, ['id' => 'exchange_rate']) !!}
{!! Form::hidden('base_amount', null, ['id' => 'base_amount']) !!}
...
{!! Form::select("account_id", $accounts, !empty($payment_line->account_id) ? $payment_line->account_id : '' , ['class' => 'form-control select2', 'id' => "account_id", 'style' => 'width:100%;', 'required' => true]); !!}
              </div>
            </div>
          </div>
        @endif
