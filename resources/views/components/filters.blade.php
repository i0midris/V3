...
<div
    class="tw-transition-all tw-mb-4 lg:tw-col-span-1 tw-duration-200 tw-bg-white tw-shadow-sm tw-rounded-md tw-ring-1 hover:tw-shadow-md tw-ring-gray-200">
    <div class="box-header with-border">
        <h3 class="box-title tw-pt-2 tw-pb-2 tw-pl-2" >
            <a data-toggle="collapse" data-parent="#accordion" href="#collapseFilter" class="custom-header" style="cursor: pointer;">
                @if (!empty($icon))
                    {!! $icon !!}
                @else
