                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                {!! Form::file('sales', ['class'=>'tw-p-1','required' => 'required']); !!}
                              </div>
                        </div>
                        <div class="col-sm-4">
                        <br>
                            <button 
                                type="submit" 
                                class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-mt-1" 
                                style="width:10rem !important"
                            >@lang('lang_v1.upload_and_review')</button>
                        </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <br>
                            <a href="{{ asset('files/import_sales_template.xlsx') }}" class="tw-dw-btn tw-mx-4 tw-dw-btn-success tw-text-white" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file')</a>
                        </div>
                    </div>
