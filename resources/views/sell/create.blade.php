...
<div class="row">
	<div class="col-sm-4">
		<div class="form-group tw-flex tw-items-center tw-gap-3">
...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
		...
		<div class="col-md-12 col-sm-12">
			@component('components.widget', ['class' => 'box-solid'])
				...
				@if(in_array('types_of_service', $enabled_modules) && !empty($types_of_service))
					<div class="col-md-4 col-sm-6">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon">
									<i class="fa fa-external-link-square-alt text-white service_modal_btn"></i>
								</span>
				...
				@if(in_array('subscription', $enabled_modules))
					<div class="col-md-4 pull-right col-sm-6 tw-flex tw-gap-1">
						<button type="button" data-toggle="modal" data-target="#recurringInvoiceModal" class="input-group-addon">
							<i class="fa fa-external-link-square-alt text-white"></i>
						</button>
						<div class="checkbox">
							<label>
				              {!! Form::checkbox('is_recurring', 1, false, ['class' => 'input-icheck', 'id' => 'is_recurring']); !!} 
							  <span class="tw-mx-2">@lang('lang_v1.subscribe')?</span>
				            </label>
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							{!! Form::select('contact_id', 
								[], null, ['class' => 'form-control mousetrap','style'=>'width:80% !important', 'id' => 'customer_id', 'placeholder' => 'Enter Customer name / phone', 'required']); !!}
							<span class="">
				...
				<div class="col-sm-6 col-lg-4">
		          <div class="form-group">
					...
					@endphp
		              ...
		              <br/>
					  <div class="input-group">
						  {!! Form::number('pay_term_number', $walk_in_customer['pay_term_number'], ['class' => 'form-control input-group-addon width-40 pull-left', 'placeholder' => __('contact.pay_term'), 'required' => $is_pay_term_required]); !!}
	        ...
	        <div class="col-md-12 text-center">
				<button type="button" class="add-btn tw-gap-3" id="toggle_additional_expense"> <i class="fas fa-plus"></i> @lang('lang_v1.add_additional_expenses') <i class="fas fa-chevron-down"></i></button>
			</div>
			<div class="col-md-8 col-md-offset-2" id="additional_expenses_div" style="display: none;">
                ...
                <div class="payment_row">
					<div class="row">
						<div class="col-md-12">
			        		...
			        		<br/>
			        		<span class="text-bold change_return_span">0</span>
	...
	<div class="row">
		...
		<div class="col-sm-12 text-center tw-mt-4">
			<button type="button" id="submit-sell" class="tw-dw-btn tw-dw-btn-primary tw-text-white">@lang('messages.save')</button>
			<button type="button" id="save-and-print" class="tw-dw-btn tw-dw-btn-success tw-text-white">@lang('lang_v1.save_and_print')</button>
		</div>
	</div>
