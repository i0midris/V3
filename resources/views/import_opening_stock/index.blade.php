...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('lang_v1.import_opening_stock')djsfjsd</h1>
</section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                {!! Form::file('products_csv', ['accept'=> '.xls', 'class'=>'tw-p-1', 'required' => 'required']); !!}
                              </div>
                        </div>
                        <div class="col-sm-4">
                        <br>
                            <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-mt-1">@lang('messages.submit')</button>
                        </div>
                        </div>
                    </div>
